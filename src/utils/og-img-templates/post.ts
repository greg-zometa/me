...
export const postOgImg = (post: CollectionEntry<"blog">, { accent, border, fill, textBase }: ColorOptions) => {
  ...
  const fontSize6xl = "34px";
  const fontWeightSemibold = 600;
  const fontWeightBold = 700;
  const letterSpacingNormal = 0;
  const letterSpacingWide = "0.4px";
  const letterSpacingWider = "0.8px";
  const lineHeight2 = "16px";
  const lineHeight4 = "24px";
  const lineHeight8 = "40px";
  const space3 = "12px";
  const space4 = "16px";
  const space8 = "32px";
  ...
  return {
    type: "section",
    props: {
      style: { display: "flex", backgroundColor: fill, height: "100vh" },
      children: [
        {
          type: "div",
          props: {
            style: { display: "flex", width: "100%", placeSelf: "center" },
            children: [
              {
                type: "div",
                props: {
                        ...
                        children: [
                          ...
                          },
                          {
                            ...
                            props: {
                              ...
                              children: post.data.readingTime
                            }
                          }
                        ]
                      }
                  ...
                  children: [
                    {
                      ...
                      props: {
                        style: {
                          ...
                          width: "100%",
                          height: "100%",
                          clipPath: "polygon(90px 0px, 0px 100%, 100% 100%, 100% 0px)",
